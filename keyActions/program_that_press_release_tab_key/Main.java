...
public class Main {
    ...
    public static void main(String[] stringArray) {
        ...
        try {
            object = new Robot();
            ((Robot)object).keyPress(9);
            ((Robot)object).keyRelease(9);
            System.out.println("Done.");
        }
        catch (Exception exception) {
            System.out.println("Failed to press TAB: " + String.valueOf(exception));
        ...
        try {
            ...
            System.out.println("Failed to create .ready: " + String.valueOf(exception));
        }
    }
}
